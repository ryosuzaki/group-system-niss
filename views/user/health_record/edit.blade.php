<form method="POST" action="{{ route('niss.health_record.update') }}">
    @csrf
    @method('PUT')
    @php
    ...
    <div id="questionnaire_body">
            ...
            <ul class="nav nav-pills nav-pills-icons d-flex justify-content-between px-0" data-tabs="tabs">
                <li class="nav-item mx-auto w-25 @if(in_array('feeling', $not_use_items)) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#1" id="t1" data-toggle="tab">調子</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('syokuyoku', $not_use_items)) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#2" id='t2' data-toggle="tab">食欲</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('otuzi', $not_use_items)) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#3" id="t3" data-toggle="tab">お通じ</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('taion', $not_use_items)) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#4" id="t4" data-toggle="tab">体温</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('taiju', $not_use_items)) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#5" id="t5" data-toggle="tab">体重</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('ketuatu', $not_use_items)) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#6" id="t6" data-toggle="tab">血圧</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('warui_bui', $not_use_items)) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#7" id="t7" data-toggle="tab">症状</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('comment', $not_use_items)) d-none @endif">
                ...
                <div class="tab-content text-center mt-3">
                    ...
                    <div class="tab-pane" id="9">
                        <p class="h2">回答一覧</p>
                        <table class="table">
                            <tr class="@if(in_array('feeling', $not_use_items)) d-none @endif"><td>調子</td><td><div id="tyousi_out"></div></td></tr>
                            <tr class="@if(in_array('syokuyoku', $not_use_items)) d-none @endif"><td>食欲</td><td><div id="syokuyoku_out"></div></td></tr>
                            <tr class="@if(in_array('otuzi', $not_use_items)) d-none @endif"><td>お通じ </td><td><div id="otuzi_out"></div></td></tr>
                            <tr class="@if(in_array('taion', $not_use_items)) d-none @endif"><td>体温 </td><td><div id="taion_out"></div></td></tr>
                            <tr class="@if(in_array('taiju', $not_use_items)) d-none @endif"><td>体重 </td><td><div id="taiju_out"></div></td></tr>
                            <tr class="@if(in_array('ketuatu', $not_use_items)) d-none @endif"><td>血圧 </td><td><div id="ketuatu_out"></div></td></tr>
                            <tr class="@if(in_array('warui_bui', $not_use_items)) d-none @endif"><td>症状</td><td><div id="warui_bui_out"></div></td></tr>
                            <tr class="@if(in_array('comment', $not_use_items)) d-none @endif"><td>コメント</td><td><div id="comment_out"></div></td></tr>
                    ...
                    <div class="form-group mb-0 mt-5">
                        <button id="helssub" type="submit" class="btn btn-primary btn-block">
                        回答して終了
                        </button>
                    </div>
                    <script type="module">
                        $(function(){
                            $('#helssub').click(function(){
                                //if(result['feeling'] == "悪い"){
                                //    var msg = "調子が悪いようですね。無理はしないでくださいね。";
                                //}
                                alert("回答ありがとうございます。\n今日も一日頑張りましょう！");
                            });
                        })
