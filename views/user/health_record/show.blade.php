...
<div class="table-responsive">
    <table class="table text-nowrap">
        <tbody>
            <tr><td style="width: 30%">回答日時</td><td style="width: 70%">{{$record->updated_at}}</td></tr>
        </tbody>
    </table>
</div>
<div class="@if(in_array('feeling', $not_use_items)) d-none @endif">
    <a href="">
...
<div class="@if(in_array('syokuyoku', $not_use_items)) d-none @endif">
    <a href="">
        <div class="card mt-0 mb-2">
            <div class="card-body">
...
<div class="@if(in_array('otuzi', $not_use_items)) d-none @endif">
    <a href="">
        <div class="card mt-0 mb-2">
            <div class="card-body">
...
<div class="@if(in_array('taion', $not_use_items)) d-none @endif">
    <a href="">
        <div class="card mt-0 mb-2">
            <div class="card-body">
...
<div class="@if(in_array('taiju', $not_use_items)) d-none @endif">
    <a href="">
        <div class="card mt-0 mb-2">
            <div class="card-body">
...
<div class="@if(in_array('ketuatu', $not_use_items)) d-none @endif">
    <a href="">
        <div class="card mt-0 mb-2">
            <div class="card-body">
...
<div class="@if(in_array('warui_bui', $not_use_items)) d-none @endif">
    <a href="">
        <div class="card mt-0 mb-2">
            <div class="card-body">
...
<div class="@if(in_array('comment', $not_use_items)) d-none @endif">
    <a href="">
        <div class="card mt-0 mb-2">
            <div class="card-body">
